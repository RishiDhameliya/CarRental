...
const ManageCars = () => {
  ...
  return (
    ...
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Cars" subTitle="View all listed cars, update their details, or remove them from a booking platform." />
      <div className='max-w-3xl w-full rounded-md overflow-hidden border border-boardercolor mt-6'>
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          ...
          <tbody>
            {cars.map((car, index) => (
              <tr key={index} className='border-t border-boardercolor'>
