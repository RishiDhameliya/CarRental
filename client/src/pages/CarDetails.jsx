      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        <motion.div
          ...
          <motion.div
            ...
            <hr className='border-boardercolor my-6' />
        ...
        <motion.form
          ...
          <div className='flex flex-col gap-2'>
            ...
            <input value={pickupDate} onChange={(e) => setPickupDate(e.target.value)}
              type="date" className='border border-boardercolor px-3 py-2 rounded-lg' required id='pickup-date' min={new Date().toISOString().split('T')[0]} />

          </div>
          <div className='flex flex-col gap-2'>
            <label htmlFor="return-date">Return Date</label>
            <input value={returnDate} onChange={(e) => setReturnDate(e.target.value)}
              type="date" className='border border-boardercolor px-3 py-2 rounded-lg' required id='return-date'
            />
