...
const Testimonial = () => {
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            <Title title="What Our Customer Says" subTitle="Discover why discerning travelers Choose StayVenture for their luxury accommodation around the world" />
                    ...
                    <motion.div
                        ...
                        <div className="flex items-center gap-1 mt-4">
                            {Array(5).fill(0).map((_, index) => (
                                <img key={index} src={assets.star_icon} alt="star-coin" />
